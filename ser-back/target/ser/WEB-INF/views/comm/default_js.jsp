...
<script type="text/javascript">
    if ('ontouchstart' in document.documentElement)
        document.write("<script src='<%=basePath%>/plugins/jquery/jquery.mobile.custom.min.js'>" + "<" + "/script>");
</script>
...
<script src="<%=basePath%>/plugins/jquery-ui/jquery-ui.custom.min.js"></script>
...
<!-- ace scripts -->
<script src="<%=basePath%>/plugins/ace/js/ace-elements.min.js"></script>
<script src="<%=basePath%>/plugins/ace/js/ace.min.js"></script>

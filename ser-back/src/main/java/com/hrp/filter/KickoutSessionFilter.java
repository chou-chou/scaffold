...
import com.hrp.shiro.cache.VCache;
...
import com.hrp.utils.lang.ShiroFilterUtils;
...
public class KickoutSessionFilter extends AccessControlFilter {
    ...
    protected boolean isAccessAllowed(ServletRequest request, ServletResponse response, Object mappedValue) throws Exception {
        ...
        if (null != marker && marker ) {
            ...
            if (ShiroFilterUtils.isAjax(request) ) {
                LoggerUtils.debug("当前用户已经在其他地方登录，并且是Ajax请求！");
        ...
        if(infoMap.containsKey(userId) && !infoMap.containsValue(sessionId)){
            ...
            if(null != oldSession){
                ...
                LoggerUtils.debug("kickout old session success,oldId : " + oldSessionId);
            }else{
    ...
    private void out(ServletResponse response, Map<String, String> resultMap)
        ...
        try {
            ...
            LoggerUtils.error("KickoutSessionFilter.class 输出JSON异常，可以忽略。");
        }
    }

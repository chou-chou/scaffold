...
public class Page {
    ...
    public Page(){
        try {
            String page = PropsUtil.getValue("page.size", Constant.CONFIG);
            this.showCount = Integer.parseInt(StringUtil.isBlankOrNull(page) ? page : "10");
        } catch (Exception e) {
            this.showCount = 10;
        }
    }

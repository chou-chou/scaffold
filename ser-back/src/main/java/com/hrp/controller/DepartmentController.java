...
public class DepartmentController extends BaseController {
    ...
    // menu模块基础路径
    private final static String BASE_PATH = "system/department/";  // --> WEB-INF/views/system/dictionary/
    ...
    public ModelAndView list(HttpServletRequest request, HttpServletResponse response) {
        ModelAndView mv = this.getModelAndView("system/department/department_main");

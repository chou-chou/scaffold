...
$.extend(!0, $.fn.dataTable.defaults, {
    ...
    bootstrap: {
        fnInit: function (a, b, c) {
            ...
            $(b).append('<ul class="pagination"><li class="prev disabled"><a href="#"><i class="fa fa-angle-double-left"></i></a></li><li class="prev disabled"><a href="#"><i class="fa fa-angle-left"></i></a></li><li class="next disabled"><a href="#"><i class="fa fa-angle-shiro"></i></a></li><li class="next disabled"><a href="#"><i class="fa fa-angle-double-shiro"></i></a></li></ul>');
            var e = $("a", b);

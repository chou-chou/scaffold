...
<head>
    ...
    <script src="<%=basePath%>/static/js/dataTables.buttons.js"></script>
    <script src="<%=basePath%>/static/js/buttons.flash.js"></script>
    <script src="<%=basePath%>/static/js/buttons.html5.js"></script>
    <script src="<%=basePath%>/static/js/buttons.print.js"></script>
    <script src="<%=basePath%>/static/js/buttons.colVis.js"></script>
    <script src="<%=basePath%>/static/js/dataTables.select.js"></script>
...
<script type="text/javascript">
    jQuery(function ($) {
        ...
        var menu_list_table = $('#menu_list').DataTable({
            ...
            language: {
                "url": "<%=basePath%>/static/js/dataTables_zh-CN.json"
            }
        });

            ...
            <div class="page-content">
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <table id="menu_list" class="table table-striped table-bordered table-hover" style="margin-top:5px;">
                                    <thead>
                                    <tr>
                                                    ...
                                                    <td class="center" style="width:50px;">
                                                        <label class="pos-rel">
                                                            <input type="checkbox" name="ids" value="${user.USER_ID}"
                                                                id="${user.USER_ID}" alt="${user.ACCOUNT}" class="ace"/>
                                                            <span class="lbl"></span>
                                                        </label>
                                                    </td>
                                    ...
                                    <table style="width:100%">
                                        <tr>
                                            <td style="vertical-align: top;">
                                                ...
                                                <c:if test="${QX.email == 1 }">
                                                    <a title="批量发送电子邮件" class="btn btn-mini btn-info" onclick="makeAll('确定要给选中的用户发送邮件吗?');">
                                                        <i class="ace-icon fa fa-envelope bigger-120"></i>
                                                    </a>
                                                </c:if>
                                                <c:if test="${QX.sms == 1 }">
...
<%--<%@ include file="../../comm/default_js.jsp" %>--%>

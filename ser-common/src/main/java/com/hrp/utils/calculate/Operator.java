...
public abstract class Operator {
    ...
    public final static Operator DIVITION = new Operator('/', 200) {
        public BigDecimal eval(BigDecimal left, BigDecimal right) throws Exception {
            right = right.stripTrailingZeros();
            BigDecimal result = null;
            try {
                result = left.divide(right, 3, BigDecimal.ROUND_HALF_UP);
     ...
     * @throws Exception
     */
    public abstract BigDecimal eval(BigDecimal left, BigDecimal right) throws Exception;

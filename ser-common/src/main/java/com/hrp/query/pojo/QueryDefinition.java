package com.hrp.query.pojo;

import com.hrp.query.entity.Query;
import com.hrp.query.entity.QueryContext;
import com.hrp.utils.ConfigurationUtil;
            ...
            for (int i = 0; i < resources.length; i++) {
                ...
                try {
                    QueryContext queryContext = (QueryContext) ConfigurationUtil.parseXMLObject(
                            com.hrp.query.entity.QueryContext.class, resource);

package com.hrp.query.controller;

import com.alibaba.fastjson.JSON;
import com.hrp.query.entity.Column;
import com.hrp.query.entity.ColumnConfig;
import com.hrp.query.entity.Query;
import com.hrp.query.entity.QueryConfig;
...
public class QueryController {
    ...
    public ColumnConfig getConfigData(String queryId, String pageName, HttpSession session) {
        ...
        list = queryService.findByCriteria(criteria);*/
